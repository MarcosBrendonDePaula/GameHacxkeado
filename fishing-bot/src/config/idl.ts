...
export const FOGO_FISHING_IDL = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "recipient_ata",
          "docs": [
            "The recipient's FISH token account"
          ],
          "writable": true
        },
        {
    ...
    },
    {
      ...
      "docs": [
        "TESTNET ONLY: Reset legacy_yield_claimed flag for test cycle reruns"
      ],
      "discriminator": [
        97,
        230,
    ...
    },
    {
      ...
      "docs": [
        "TESTNET ONLY: Set a player's last_claim_fees_snapshot for yield testing"
      ],
      "discriminator": [
        155,
        25,
      ...
      "accounts": [
        {
          "name": "signer",
          "docs": [
            "The signer (session key or user wallet)"
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "config",
          "docs": [
            "Global config (issuer key, gating flags)"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          ...
          "docs": [
            "Buyback Treasury - receives 70% of bait USDC fees"
          ],
          "writable": true
        },
        {
          ...
          "docs": [
            "Liquidity Treasury - receives 20% of bait USDC fees"
          ],
          "writable": true
        },
        {
          "name": "ops_treasury",
          "docs": [
            "Ops Treasury - receives 10% of bait USDC fees"
          ],
          "writable": true
        },
        {
          "name": "program_signer",
          "docs": [
            "Program signer PDA for Fogo Sessions token transfers/burns"
          ],
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "player_state",
          "docs": [
            "Player state PDA based on owner"
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "buyback_treasury",
          "docs": [
            "Buyback Treasury - receives 50% of supercast fees"
          ],
          "writable": true
        },
        {
          "name": "liquidity_treasury",
          "docs": [
            "Liquidity Treasury - receives 10% of supercast fees"
          ],
          "writable": true
        },
        {
          "name": "ops_treasury",
          "docs": [
            "Ops Treasury - receives 40% of supercast fees"
          ],
          "writable": true
        },
        {
          "name": "program_signer",
          "docs": [
            "Program signer PDA for Fogo Sessions token transfers"
          ],
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "config",
          "docs": [
            "Global config (issuer key, flags)"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "river_fish_config",
          "docs": [
            "Season 2 River Fish config (read-only)"
          ],
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "config",
          "docs": [
            "because the on-chain schema doesn't match the current code"
          ],
          "writable": true,
          "pda": {
            "seeds": [
      ...
      "accounts": [
        {
          "name": "fee_payer",
          "docs": [
            "The transaction fee payer (paymaster in production)"
          ],
          "writable": true,
          "signer": true
        },
        {
          "name": "owner",
          "docs": [
            "The player wallet who is registering a referrer"
          ]
        },
        {
          "name": "referrer_info",
          "docs": [
            "ReferrerInfo PDA - stores the referrer relationship",
            "Seeds: [\"referrer\", owner]"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "buyback_treasury",
          "docs": [
            "Buyback Treasury - receives 50% of repair fees"
          ],
          "writable": true
        },
        {
          "name": "liquidity_treasury",
          "docs": [
            "Liquidity Treasury - receives 10% of repair fees"
          ],
          "writable": true
        },
        {
          "name": "ops_treasury",
          "docs": [
            "Ops Treasury - receives 40% of repair fees"
          ],
          "writable": true
        },
        {
    ...
    },
    {
      ...
      "docs": [
        "DEV ONLY: Enforce repair threshold and restore to full without token transfers."
      ],
      "discriminator": [
        114,
        248,
    ...
    },
    {
      ...
      "docs": [
        "DEV ONLY: Shift durability timestamp backwards to simulate elapsed time for regen."
      ],
      "discriminator": [
        148,
        123,
    ...
    },
    {
      "name": "finish_upgrade",
      "docs": [
        "ECONOMIC REBALANCE: Finish upgrade (completes after cast requirement met)"
      ],
      "discriminator": [
        41,
        200,
    ...
    },
    {
      ...
      "docs": [
        "Initialize a player's collection grid"
      ],
      "discriminator": [
        3,
        111,
      ...
      "accounts": [
        ...
        },
        {
          "name": "river_fish_config",
          "docs": [
            "River fish config (Season 2 board uses 32 slots)"
          ],
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "docs": [
        "Initialize a player's RiverFishState PDA."
      ],
      "discriminator": [
        170,
        109,
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "require_capability_for_catch",
          "type": "bool"
        },
        {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "owner",
          "docs": [
            "The owner wallet (NOT a signer - this is who owns the tokens and player state)"
          ]
        },
        {
          "name": "global_state",
        ...
        },
        {
          "name": "player_state",
          "docs": [
            "Player state PDA based on OWNER wallet (not signer)"
          ],
          "writable": true,
          "pda": {
            "seeds": [
      ...
      "accounts": [
        {
          "name": "fee_payer",
          "docs": [
            "The transaction fee payer (covers account creations)"
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "owner_fish_ata",
          "docs": [
            "FISH token account for owner - ensure it exists"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "docs": [
        "Initialize player with explicit boat tier: 1=Free, 2=Mid, 3=Premium, 4=Trump"
      ],
      "discriminator": [
        250,
        239,
    ...
    },
    {
      ...
      "accounts": [
        {
          "name": "fee_payer",
          "docs": [
            "Pays for new accounts (mint, ATAs, metadata)"
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "global_state",
          "docs": [
            "Global state PDA used as mint + metadata update authority"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "river_fish_state",
          "docs": [
            "Player river fish state (pending queue is mutated)"
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "nft_mint",
          "docs": [
            "New NFT mint (created for this fish). Nonce allows retry on PDA collision."
          ],
          "writable": true
        },
        {
          "name": "owner_nft_ata",
          "docs": [
            "Owner's NFT token account (ATA) receiving the minted fish"
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          ...
          "docs": [
            "Record PDA proving this mint corresponds to a Season 2 river fish"
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "collection_mint",
          "docs": [
            "The collection NFT mint (verified at runtime via VerifySizedCollectionItem CPI)"
          ]
        },
        {
      ...
      "args": [
        ...
        {
          "name": "expected_fish_id",
          "type": "u8"
        },
        {
          "name": "expected_cast_count",
          "type": "u64"
        },
        {
          "name": "uri",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "global_state",
          "docs": [
            "Global state (for fish_mint reference)"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "config",
          "docs": [
            "Global config (issuer key, gating flags — needed for spend capability)"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "river_fish_config",
          "docs": [
            "River fish config for validation + rarity lookup"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "river_fish_mint_record",
          "docs": [
            "Per-mint record proving this is a Season 2 river fish minted by the program"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "nft_mint",
          "docs": [
            "The NFT mint being placed/burned"
          ],
          "writable": true
        },
        {
          "name": "owner_nft_ata",
          "docs": [
            "Owner's NFT token account (will be burned from)"
          ],
          "writable": true
        },
        {
          "name": "nft_metadata",
          "docs": [
            "Address: PDA from Metaplex with seeds [\"metadata\", token_metadata_program, nft_mint]"
          ]
        },
        {
          "name": "fish_mint",
        ...
        },
        {
          "name": "owner_fish_ata",
          "docs": [
            "Owner's FISH token account (FISH burned from here)"
          ],
          "writable": true
        },
        {
          "name": "program_signer",
          "docs": [
            "Program signer PDA for Fogo Sessions token burns"
          ],
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "owner_fogo_ata",
          "docs": [
            "USDC tokens from OWNER (session signer has delegated authority to spend)"
          ],
          "writable": true
        },
        {
          "name": "buyback_treasury",
          "docs": [
            "Buyback Treasury - receives 70% of processing fees"
          ],
          "writable": true
        },
        {
          "name": "liquidity_treasury",
          "docs": [
            "Liquidity Treasury - receives 20% of processing fees"
          ],
          "writable": true
        },
        {
          "name": "ops_treasury",
          "docs": [
            "Ops Treasury - receives 10% of processing fees"
          ],
          "writable": true
        },
        {
      ...
      "accounts": [
        {
          "name": "signer",
          "docs": [
            "Any signer (payer); permissionless"
          ],
          "signer": true
        },
        {
    ...
    },
    {
      ...
      "docs": [
        "ADMIN ONLY: Reset halving count (emergency fix for incorrect halvings)"
      ],
      "discriminator": [
        0,
        245,
    ...
    },
    {
      ...
      "docs": [
        "ADMIN: Set per-bait USDC fee (6 decimals). Required before activation."
      ],
      "discriminator": [
        31,
        86,
    ...
    },
    {
      ...
      "docs": [
        "ADMIN: Activate or deactivate the River Fish system."
      ],
      "discriminator": [
        222,
        82,
    ...
    },
    {
      ...
      "docs": [
        "ADMIN: Update the collection mint stored in RiverFishConfig."
      ],
      "discriminator": [
        114,
        46,
    ...
    },
    {
      ...
      "docs": [
        "ADMIN: Set fish_count (must be 32 before activation)."
      ],
      "discriminator": [
        70,
        7,
    ...
    },
    {
      ...
      "docs": [
        "ECONOMIC REBALANCE: Skip upgrade timer (instantly completes for FOGO payment)"
      ],
      "discriminator": [
        141,
        215,
      ...
      "accounts": [
        ...
        },
        {
          "name": "buyback_treasury",
          "docs": [
            "Buyback Treasury - receives 50% of skip fees"
          ],
          "writable": true
        },
        {
          "name": "liquidity_treasury",
          "docs": [
            "Liquidity Treasury - receives 10% of skip fees"
          ],
          "writable": true
        },
        {
          "name": "ops_treasury",
          "docs": [
            "Ops Treasury - receives 40% of skip fees"
          ],
          "writable": true
        },
        {
    ...
    },
    {
      "name": "start_upgrade",
      "docs": [
        "ECONOMIC REBALANCE: Start upgrade (burns FISH+FOGO, starts cast timer)"
      ],
      "discriminator": [
        134,
        190,
      ...
      "accounts": [
        ...
        },
        {
          "name": "owner_fish_ata",
          "docs": [
            "FISH tokens from OWNER's account"
          ],
          "writable": true
        },
        {
  ...
  "types": [
    {
      "name": "CollectionGrid",
      "docs": [
        "Collection grid progress per player",
        "Seeds: [\"grid\", owner.key()]"
      ],
      "type": {
        "kind": "struct",
        "fields": [
        ...
        "fields": [
          {
            ...
            "docs": [
              "Total fish (unprocessed + minted) at the start of the current tracking period"
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            "name": "authority",
            "docs": [
              "Authority that can update this (should match GlobalState authority)"
            ],
            "type": "pubkey"
          },
          {
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "total_network_power",
            "type": "u64"
          },
          {
            "name": "last_difficulty_adjustment",
            "type": "i64"
          },
          {
          ...
          {
            "name": "emission_decay_rate",
            "type": "u64"
          },
          {
            "name": "daily_target_emission",
            "type": "u64"
          },
          {
            "name": "total_fogo_collected",
            "type": "u128"
          },
          {
            "name": "total_fish_minted",
            "type": "u64"
          },
          {
            "name": "total_unprocessed_fish",
            "type": "u64"
          },
          {
            "name": "accumulated_processing_fees",
            "type": "u64"
          },
          {
            "name": "fees_per_unprocessed_fish",
            "type": "u128"
          },
          {
            "name": "bump",
    ...
    },
    {
      ...
      "docs": [
        "Pending river fish catch entry created during `cast_line` and minted later."
      ],
      "type": {
        "kind": "struct",
        "fields": [
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "supercast_remaining_casts",
            "type": "u32"
          },
          {
            "name": "last_durability_ts",
            "type": "i64"
          },
          {
            "name": "unprocessed_fish",
            "type": "u64"
          },
          {
            "name": "last_claim_fees_snapshot",
            "type": "u128"
          },
          {
            "name": "last_recorded_unprocessed",
            "type": "u64"
          },
          {
          ...
          {
            "name": "upgrade_target_level",
            "type": "u8"
          },
          {
            "name": "upgrade_casts_at_start",
            "type": "u64"
          },
          {
            "name": "last_ata_creation_slot",
            "type": "u64"
          },
          {
            "name": "last_cast_slot",
          ...
          {
            "name": "first_process_fee_paid",
            "type": "bool"
          },
          {
            "name": "legacy_yield_claimed",
            "type": "u8"
          },
          {
            "name": "_reserved",
        ...
        "fields": [
          {
            "name": "player",
            "docs": [
              "The player wallet this referrer info belongs to"
            ],
            "type": "pubkey"
          },
          {
            "name": "referrer",
            "docs": [
              "The wallet that referred this player (receives 1% of processing fees)"
            ],
            "type": "pubkey"
          },
          {
    ...
    },
    {
      "name": "RiverBaitDef",
      "docs": [
        "Definition of a single bait type."
      ],
      "type": {
        "kind": "struct",
        "fields": [
          ...
          },
          {
            "name": "fish_cost_at_ref_difficulty",
            "docs": [
              "FISH cost in lamports (6 decimals) at difficulty_ref (e.g. D=500)."
            ],
            "type": "u64"
          },
          {
            "name": "usdc_fee",
            "docs": [
              "Flat USDC fee in lamports (6 decimals) charged per purchase (config-driven)."
            ],
            "type": "u64"
          }
        ]
    ...
    },
    {
      "name": "RiverFishConfig",
      "docs": [
        "Global config PDA for the Season 2 River Fish system.",
        "Seeds: [\"river-fish-config\"]"
      ],
      "type": {
        "kind": "struct",
        "fields": [
          ...
          },
          {
            "name": "difficulty_ref",
            "docs": [
              "Reference difficulty used for `fish_cost_at_ref_difficulty` (doc uses D=500)."
            ],
            "type": "u64"
          },
          {
    ...
    },
    {
      "name": "RiverFishState",
      "docs": [
        "Per-player state PDA for the Season 2 River Fish system.",
        "Seeds: [\"river-fish-state\", owner]"
      ],
      "type": {
        "kind": "struct",
        "fields": [
          ...
          },
          {
            ...
            "docs": [
              "Remaining casts per bait type (10 buckets). Index = bait_id-1."
            ],
            "type": {
              "array": [
                "u32",
          ...
          },
          {
            "name": "pending",
            "docs": [
              "Fixed-size ring buffer of pending fish catches."
            ],
            "type": {
              "array": [
                {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "catch_rate_ppb",
            "docs": [
              "Catch probability per cast in parts-per-billion (ppb), i.e. 1e9 = 100%."
            ],
            "type": "u64"
          }
        ]
