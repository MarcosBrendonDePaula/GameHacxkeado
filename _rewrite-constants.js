...
const newContent = `import { PublicKey } from "@solana/web3.js";
...
fs.writeFileSync('fishing-bot/src/config/constants.ts', newContent);
console.log('constants.ts rewritten:', newContent.length, 'bytes');
